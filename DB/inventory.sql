...
-- Volcando datos para la tabla db_inventory.categories: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla db_inventory.companies: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla db_inventory.customers: ~3 rows (aproximadamente)
...
INSERT INTO `menus` (`id`, `parent_id`, `name`, `icon`, `menu_url`, `status`, `created_at`, `updated_at`) VALUES
	(1, 0, 'Capatas', 'contacts', 'customer.index', 0, '2020-07-29 13:17:51', '2020-07-29 13:17:56'),
...
-- Volcando datos para la tabla db_inventory.products: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla db_inventory.sells: ~2 rows (aproximadamente)
DELETE FROM `sells`;
...
-- Volcando datos para la tabla db_inventory.sell_details: ~2 rows (aproximadamente)
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `branch_id`, `role_id`, `remember_token`, `created_at`, `updated_at`) VALUES
	(12, 'Byron Guevara', 'bayronh05@gmail.com', '$2y$10$W/nqTuN0X.JaGtGBkpw01OTSL0I3aShYL9QusP8Q5kIZ2AviqQHKC', 1, 2, 'dBb3azxZsjqiPA48gqNl2Ca1WDjc6zDZrKeW4ucnbW2lywQtWf5BMs7MpD28', '2020-07-31 17:27:25', '2023-04-17 05:20:18'),
...
-- Volcando datos para la tabla db_inventory.vendors: ~4 rows (aproximadamente)
DELETE FROM `vendors`;
