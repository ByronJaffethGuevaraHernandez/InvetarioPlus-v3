              ...
              <div class="input-group">
                ...
                <div class="form-line">
                  <select class="form-control" v-model="invoice.customer_type">
                    <option value>Seleccionar Capatas</option>
                    <option :value="1">De la base de datos</option>
                    <option :value="2">Nuevo Capatas</option>
                  </select>
              ...
              <div class="input-group">
                ...
                <div class="form-line">
                  <multiselect v-model="invoice.customer_id" deselect-label="" track-by="id" label="customer_name"
                    open-direction="bottom" placeholder="Seleccionar Capatas" :options="customers" :allow-empty="false">
                  </multiselect>
